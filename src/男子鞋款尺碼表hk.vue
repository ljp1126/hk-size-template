 ...
 * @LastEditTime: 2022-04-20 11:31:17
              ...
              <div class="select-type">
                <div class="select-numb">
                  <span class="select-show">
                    <span class="show-content" id="show-content-one">歐洲碼(EU)</span>
                  ...
                  <div class="size-options" id="size-options-one" style="display: none">
                    ...
                    <div class="optionsItem" id="usm-code-one">美國碼(US) – 男子</div>
                    <div class="optionsItem" id="usw-code-one">美國碼(US) – 女子</div>
                    <div class="optionsItem" id="cn-code-one">中國碼(CN)</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class='size-chart' id="usm-code-item-one" style="display:none">
            <table> 
              <tbody> 
                <tr class="tr-color tr-title"> 
                  <td style="width: 33%"><span>英國碼(UK)</span></td> 
                  <td style="width: 33%"><span>美國碼 (US) - 男子</span></td> 
                  <td style="width: 34%"><span>腳掌尺寸(厘米)</span></td> 
                </tr> 
                <tr class=""> 
                  <td><span> 3</span></td> 
          ...
          <div class='size-chart' id="usw-code-item-one" style="display:none">
            <table> 
              <tbody> 
                <tr class="tr-color tr-title"> 
                  <td style="width: 33%"><span>英國碼(UK)</span></td> 
                  <td style="width: 33%"><span>美國碼 (US) - 女子</span></td> 
                  <td style="width: 34%"><span>腳掌尺寸(厘米)</span></td> 
                </tr> 
                <tr class=""> 
                  <td><span> 3</span></td> 
          ...
          <div class="size-type">
            ...
            <div class="size-select">
              <div class="select-type">
                <div class="select-numb">
                  <span class="select-show">
                    <span class="show-content" id="show-content-two">歐洲碼(EU)</span>
                  ...
                  <div class="size-options" id="size-options-two" style="display: none">
                    ...
                    <div class="optionsItem" id="usm-code-two">美國碼(US) – 男子</div>
                    <div class="optionsItem" id="usw-code-two">美國碼(US) – 女子</div>
                    <div class="optionsItem" id="cn-code-two">中國碼(CN)</div>
                  </div>
                </div>
              </div>
            </div>
